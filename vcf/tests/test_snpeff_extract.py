...
1\t100\t.\tA\tG\t.\tPASS\tANN=G|missense_variant|MODERATE|gene1|GENE1_ID
1\t200\t.\tC\tT\t.\tPASS\tANN=C|stop_gained|HIGH|gene2|GENE2_ID,A|synonymous_variant|LOW|gene2|GENE2_ID_ALT
1\t300\t.\tG\tA\t.\tPASS\t.
"""
...
def test_extracts_highest_priority_annotation(tmp_path: Path) -> None:
    ...
    assert second["gene_id"] == "GENE2_ID"
