...
def compare_gt(df: pd.DataFrame, compare_a: str, compare_b: str, human: bool = True):
    ...
    homo_equal_count_out = (
        f"{homo_equal_percent:.2f}% ({homo_equal_count}/{total_homo_count})"
    )
    ...
    het_equal_count_out = (
        f"{het_equal_percent:.2f}% ({het_equal_count}/{total_het_count})"
    )
    ...
    total_a_equal_b_out = (
        f"{total_a_equal_b_percent:.2f}% ({total_a_equal_b}/{non_miss_count})"
    )
